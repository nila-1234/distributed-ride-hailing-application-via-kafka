...
public class DriverMatchTaskApplication implements TaskApplication {
    ...
    public void describe(TaskApplicationDescriptor taskApplicationDescriptor) {
        ...
        taskApplicationDescriptor.withInputStream(driverLocDescriptor);
        taskApplicationDescriptor.withInputStream(eventsDescriptor);
        taskApplicationDescriptor.withOutputStream(matchDescriptor);
